window.EID_DATA = (function () {
  ...
  const INEC_PARTIES = [
    { abbr: "APC", name: "All Progressives Congress", color: "#2f6fed", founded: 2013, logo: "/assets/parties/APC.svg" },
    { abbr: "PDP", name: "Peoples Democratic Party", color: "#cf3a4e", founded: 1998, logo: "/assets/parties/PDP.svg" },
    { abbr: "LP", name: "Labour Party", color: "#2fa84f", founded: 2002, logo: "/assets/parties/LP.svg" },
    { abbr: "NNPP", name: "New Nigeria Peoples Party", color: "#7a53d1", founded: 2002, logo: "/assets/parties/NNPP.svg" },
    { abbr: "APGA", name: "All Progressives Grand Alliance", color: "#1f9e8a", founded: 2002, logo: "/assets/parties/APGA.svg" },
    { abbr: "ADC", name: "African Democratic Congress", color: "#6f8f2f", founded: 2005, logo: "/assets/parties/ADC.svg" },
    { abbr: "SDP", name: "Social Democratic Party", color: "#3f6f9e", founded: 1990, logo: "/assets/parties/SDP.svg" },
    { abbr: "YPP", name: "Young Progressives Party", color: "#b5482f", founded: 2017, logo: "/assets/parties/YPP.png" },
    { abbr: "ADP", name: "Action Democratic Party", color: "#8a5fbf", founded: 2016, logo: "/assets/parties/ADP.svg" },
    { abbr: "AA", name: "Action Alliance", color: "#bf9a2f", founded: 2005, logo: "/assets/parties/AA.svg" },
    { abbr: "AAC", name: "African Action Congress", color: "#c0392f", founded: 2018, logo: "/assets/parties/AAC.svg" },
    { abbr: "APM", name: "Allied Peoples Movement", color: "#2f8fbf", founded: 2017, logo: "/assets/parties/APM.svg" },
    { abbr: "APP", name: "Action Peoples Party", color: "#5f9e6f", founded: 2018, logo: "/assets/parties/APP.svg" },
    { abbr: "BP", name: "Boot Party", color: "#7f6f4f", founded: 2018, logo: "/assets/parties/BP.svg" },
    { abbr: "NRM", name: "National Rescue Movement", color: "#4f8f8f", founded: 2018, logo: "/assets/parties/NRM.svg" },
    { abbr: "PRP", name: "Peoples Redemption Party", color: "#9e2f6f", founded: 1978, logo: "/assets/parties/PRP.svg" },
    { abbr: "ZLP", name: "Zenith Labour Party", color: "#2f6f5f", founded: 2018, logo: "/assets/parties/ZLP.svg" },
    { abbr: "A", name: "Accord", color: "#8f7f2f", founded: 2006, logo: "/assets/parties/A.svg" },
  ];
