...
function staticCatalogEntries() {
  ...
  return [
    ...
    {
      id: 'reference:stears-africa-past-tracker',
      name: 'Stears Open Data · Africa recent election tracker',
      category: 'reference',
      country: 'global',
      office: null,
      year: null,
      ...
      formats: ['csv'],
      fmt: 'CSV',
      coverage: 'Multi-country · recent African elections',
      source: 'Stears Open Data',
      updated: '2026-09-17',
      icon: 'public',
      public: true,
      kind: 'static-file',
      href: '/data/stears-open-data/africa-past-tracker.csv',
      notes: 'Attribution: Stears Open Data (https://www.stears.co/open-data/). Sourced from https://www.stears.co/elections/recent-african-elections/.',
    },
    {
      id: 'reference:stears-africa-upcoming-tracker',
      name: 'Stears Open Data · Africa upcoming election tracker',
      category: 'reference',
      country: 'global',
      office: null,
      year: null,
      ...
      formats: ['csv'],
      fmt: 'CSV',
      coverage: 'Multi-country · upcoming African elections',
      source: 'Stears Open Data',
      updated: '2026-09-17',
      icon: 'event',
      public: true,
      kind: 'static-file',
      href: '/data/stears-open-data/africa-upcoming-tracker.csv',
      notes: 'Attribution: Stears Open Data (https://www.stears.co/open-data/). Sourced from https://www.stears.co/elections/upcoming-african-elections/.',
    },
    {
      id: 'reference:stears-africa-democracy-level',
      name: 'Stears Open Data · Africa democracy level',
      category: 'reference',
      country: 'global',
      office: null,
      year: null,
      ...
      formats: ['csv'],
      fmt: 'CSV',
      coverage: 'Multi-country · EIU democracy regime class',
      source: 'Stears Open Data',
      updated: '2026-09-17',
      icon: 'account_balance',
      public: true,
      kind: 'static-file',
      href: '/data/stears-open-data/africa-map-democracy-level.csv',
      notes: 'Attribution: Stears Open Data. Context maps: https://www.stears.co/elections/african-election-context-maps/.',
    },
    {
      id: 'reference:stears-africa-coup-conflict',
      name: 'Stears Open Data · Africa coup & conflict status',
      category: 'reference',
      country: 'global',
      office: null,
      year: null,
      ...
      formats: ['csv'],
      fmt: 'CSV',
      coverage: 'Multi-country · civilian rule / military / conflict',
      source: 'Stears Open Data',
      updated: '2026-09-17',
      icon: 'gavel',
      public: true,
      kind: 'static-file',
      href: '/data/stears-open-data/africa-map-coup.csv',
      notes: 'Attribution: Stears Open Data. Context maps: https://www.stears.co/elections/african-election-context-maps/.',
    },
    {
      id: 'reference:stears-africa-democracy-age',
      name: 'Stears Open Data · Africa democracy age',
      category: 'reference',
      country: 'global',
      office: null,
      year: null,
      ...
      formats: ['csv'],
      fmt: 'CSV',
      coverage: 'Multi-country · uninterrupted democracy age bands',
      source: 'Stears Open Data',
      updated: '2026-09-17',
      icon: 'history',
      public: true,
      kind: 'static-file',
      href: '/data/stears-open-data/africa-map-democracy-age.csv',
      notes: 'Attribution: Stears Open Data. Context maps: https://www.stears.co/elections/african-election-context-maps/.',
    },
    {
      id: 'reference:stears-africa-population',
      name: 'Stears Open Data · Africa population (context)',
      category: 'reference',
      country: 'global',
      office: null,
      year: null,
      ...
      formats: ['csv'],
      fmt: 'CSV',
      coverage: 'Multi-country · population context layer',
      source: 'Stears Open Data',
      updated: '2026-09-17',
      icon: 'groups',
      public: true,
      kind: 'static-file',
      href: '/data/stears-open-data/africa-map-population.csv',
      notes: 'Attribution: Stears Open Data. Context maps: https://www.stears.co/elections/african-election-context-maps/.',
    },
    {
      id: 'reference:stears-africa-gdp',
      name: 'Stears Open Data · Africa GDP (context)',
      category: 'reference',
      country: 'global',
      office: null,
      year: null,
      ...
      formats: ['csv'],
      fmt: 'CSV',
      coverage: 'Multi-country · GDP context layer',
      source: 'Stears Open Data',
      updated: '2026-09-17',
      icon: 'payments',
      public: true,
      kind: 'static-file',
      href: '/data/stears-open-data/africa-map-gdp.csv',
      notes: 'Attribution: Stears Open Data. Context maps: https://www.stears.co/elections/african-election-context-maps/.',
    },
    {
      id: 'reference:stears-open-data-manifest',
      name: 'Stears Open Data · ingest manifest',
      category: 'reference',
      country: 'global',
      office: null,
      year: null,
      ...
      formats: ['json'],
      fmt: 'JSON',
      coverage: 'File list + attribution for Africa tracker CSVs',
      source: 'Stears Open Data',
      updated: '2026-09-17',
      icon: 'description',
      public: true,
      kind: 'static-json',
      href: '/data/stears-open-data/manifest.json',
      notes: 'Local ingest record. Constituency GeoJSON not bundled (docs/STEARS_BOUNDARIES_LICENCE.md).',
    },
    {
...
function withDownloadUrls(entry) {
  ...
  for (const fmt of formats) {
    if ((fmt === 'zip' || fmt === 'csv') && entry.href && entry.kind === 'static-file') {
      downloads[fmt] = entry.href;
      continue;
    }
