/**
 * Transform Playwright fetch dump → presidential-2023-lga.json + aggregate check.
 * Input: agent-tools dump OR scripts/_wiki_raw/stears-pres-lga-fetch.json
 */
'use strict';
...
function loadDump(file) {
  ...
  // Prefer first complete JSON object (agent-tools dumps append markdown/code after).
  try {
...
function main() {
  ...
  // Persist raw dump for reproducibility (compact — pretty-print is huge/slow)
